...
format:
  revealjs:
    ...
    slide-number: true
    preview-links: auto
    footer: "Le code source de cette présentation est disponible [sur GitHub](https://github.com/DanChaltiel/presentations/openscience_cesp/){target='_blank'}."
execute:
  echo: true
...
:::: {.columns}
::: {.column width="32%"}
Si deux personnes travaillent en parallèle à partir du même commit, il peut y avoir don peut résoudre les conflits très facilement.
:::
